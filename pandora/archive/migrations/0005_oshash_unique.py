...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'File', fields ['oshash']
        db.create_unique('archive_file', ['oshash'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'File', fields ['oshash']
        db.delete_unique('archive_file', ['oshash'])
    ...
    models = {
        ...
        'archive.fileinstance': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'mtime': ('django.db.models.fields.IntegerField', [], {'default': '1281372184'}),
