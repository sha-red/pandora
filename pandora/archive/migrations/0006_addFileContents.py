...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Stream.source'
        db.alter_column('archive_stream', 'source_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['archive.Stream']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Stream.source'
        db.alter_column('archive_stream', 'source_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['archive.Stream'], blank=True))
    ...
    models = {
        ...
        'archive.filecontents': {
            'Meta': {'object_name': 'FileContents'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'data': ('django.db.models.fields.TextField', [], {'default': "u''"}),
            'file': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'contents'", 'to': "orm['archive.File']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        'archive.fileinstance': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'mtime': ('django.db.models.fields.IntegerField', [], {'default': '1282476196'}),
