...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Layer.start'
        db.add_column('backend_layer', 'start', orm['backend.layer:start'])
        
        # Adding field 'Layer.stop'
        db.add_column('backend_layer', 'stop', orm['backend.layer:stop'])
        
        # Adding field 'MovieFind.dialog'
        db.add_column('backend_moviefind', 'dialog', orm['backend.moviefind:dialog'])
        
        # Deleting field 'Layer.time_in'
        db.delete_column('backend_layer', 'time_in')
        
        # Deleting field 'Layer.time_out'
        db.delete_column('backend_layer', 'time_out')
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Layer.start'
        db.delete_column('backend_layer', 'start')
        
        # Deleting field 'Layer.stop'
        db.delete_column('backend_layer', 'stop')
        
        # Deleting field 'MovieFind.dialog'
        db.delete_column('backend_moviefind', 'dialog')
        
        # Adding field 'Layer.time_in'
        db.add_column('backend_layer', 'time_in', orm['backend.layer:time_in'])
        
        # Adding field 'Layer.time_out'
