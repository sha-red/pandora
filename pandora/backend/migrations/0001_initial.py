...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('backend_movie', (
            ...
            ('published', orm['backend.Movie:published']),
            ...
            ('extra', orm['backend.Movie:extra']),
            ('json', orm['backend.Movie:json']),
            ('stream_low', orm['backend.Movie:stream_low']),
            ('stream_mid', orm['backend.Movie:stream_mid']),
            ('stream_high', orm['backend.Movie:stream_high']),
        ...
        db.create_table('backend_movieextra', (
            ('id', orm['backend.MovieExtra:id']),
            ('created', orm['backend.MovieExtra:created']),
            ('modified', orm['backend.MovieExtra:modified']),
            ('title', orm['backend.MovieExtra:title']),
            ('description', orm['backend.MovieExtra:description']),
            ('contributor', orm['backend.MovieExtra:contributor']),
            ('rights_level', orm['backend.MovieExtra:rights_level']),
        ))
        ...
        db.create_table('backend_frame', (
            ('id', orm['backend.Frame:id']),
            ('created', orm['backend.Frame:created']),
            ('modified', orm['backend.Frame:modified']),
            ('file', orm['backend.Frame:file']),
            ('position', orm['backend.Frame:position']),
            ('frame', orm['backend.Frame:frame']),
        ))
        ...
        db.create_table('backend_file', (
            ...
            ('published', orm['backend.File:published']),
            ('verified', orm['backend.File:verified']),
            ('oshash', orm['backend.File:oshash']),
            ('sha1', orm['backend.File:sha1']),
            ('md5', orm['backend.File:md5']),
            ('movie', orm['backend.File:movie']),
            ('type', orm['backend.File:type']),
            ('info', orm['backend.File:info']),
            ('path', orm['backend.File:path']),
            ...
            ('needs_data', orm['backend.File:needs_data']),
            ('available', orm['backend.File:available']),
            ('stream_low', orm['backend.File:stream_low']),
            ('stream_mid', orm['backend.File:stream_mid']),
            ('stream_high', orm['backend.File:stream_high']),
        ))
        ...
        db.create_table('backend_collection', (
            ('id', orm['backend.Collection:id']),
            ('created', orm['backend.Collection:created']),
            ('modified', orm['backend.Collection:modified']),
            ('name', orm['backend.Collection:name']),
            ('subdomain', orm['backend.Collection:subdomain']),
            ('movies', orm['backend.Collection:movies']),
        ))
        db.send_create_signal('backend', ['Collection'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('backend_collection')
