...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Stream.info'
        db.add_column('backend_stream', 'info', self.gf('oxdjango.fields.DictField')(default={}), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Stream.info'
        db.delete_column('backend_stream', 'info')
