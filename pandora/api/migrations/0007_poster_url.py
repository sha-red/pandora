...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Movie.poster_url'
        db.add_column('backend_movie', 'poster_url', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Movie.poster_url'
        db.delete_column('backend_movie', 'poster_url')
