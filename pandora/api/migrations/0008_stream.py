...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Stream'
        db.create_table('backend_stream', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('movie', self.gf('django.db.models.fields.related.ForeignKey')(related_name='streams', to=orm['backend.Movie'])),
            ...
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='derivatives', null=True, to=orm['backend.Stream'])),
            ('available', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
        ))
        db.send_create_signal('backend', ['Stream'])


    def backwards(self, orm):
        
        # Deleting model 'Stream'
        db.delete_table('backend_stream')
